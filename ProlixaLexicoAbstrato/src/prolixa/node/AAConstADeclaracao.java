...
public final class AAConstADeclaracao extends PADeclaracao
{
    private PATipo _tipo_;
    private TId _nome_;
    private PAExp _init_;

    public AAConstADeclaracao()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAAConstADeclaracao(this);
    }
