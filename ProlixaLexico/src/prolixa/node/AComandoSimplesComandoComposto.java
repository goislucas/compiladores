...
public final class AComandoSimplesComandoComposto extends PComandoComposto
{
    private PComandoSimples _comandoSimples_;

    public AComandoSimplesComandoComposto()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AComandoSimplesComandoComposto(
    ...
    {
        ((Analysis) sw).caseAComandoSimplesComandoComposto(this);
    }
