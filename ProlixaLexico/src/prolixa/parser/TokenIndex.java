...
class TokenIndex extends AnalysisAdapter
{
    ...
    @Override
    public void caseTValorSymbol(@SuppressWarnings("unused") TValorSymbol node)
    {
        this.index = 21;
    }
    ...
    @Override
    public void caseTValorNumber(@SuppressWarnings("unused") TValorNumber node)
    {
        this.index = 23;
    }

    @Override
    public void caseTValorAnswer(@SuppressWarnings("unused") TValorAnswer node)
    {
        this.index = 24;
    }
    ...
    @Override
    public void caseTIgualAtribuicao(@SuppressWarnings("unused") TIgualAtribuicao node)
    {
        this.index = 44;
    }
    ...
    @Override
    public void caseTDivisaoInteira(@SuppressWarnings("unused") TDivisaoInteira node)
    {
        this.index = 49;
    }

    @Override
    public void caseTIgualComparacao(@SuppressWarnings("unused") TIgualComparacao node)
    {
        this.index = 50;
    }

    @Override
    public void caseTNaoIgual(@SuppressWarnings("unused") TNaoIgual node)
    {
        this.index = 51;
    }
    ...
    @Override
    public void caseTParentesesEsquerda(@SuppressWarnings("unused") TParentesesEsquerda node)
    {
        this.index = 60;
    }

    @Override
    public void caseTParentesesDireita(@SuppressWarnings("unused") TParentesesDireita node)
    {
        this.index = 61;
    }

    @Override
    public void caseTColchetesEsquerda(@SuppressWarnings("unused") TColchetesEsquerda node)
    {
        this.index = 62;
    }

    @Override
    public void caseTColchetesDireita(@SuppressWarnings("unused") TColchetesDireita node)
    {
        this.index = 63;
    }
